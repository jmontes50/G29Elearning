...
const useContadorStore = create(devtools((set) => {
  return {
    ...
    subirAMil: () => set({ contador: 1000 }, false, "useCountador/subirAMil"),
    incrementar: () => set((state) => ({ contador: state.contador + 1}), false, "useCountador/incrementar")
  }
}))
